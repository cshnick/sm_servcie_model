...
Contacts::Contacts(const litesql::Database& db, const litesql::Record& rec)
    ...
    defaults();
    size_t size = (rec.size() > 80) ? 80 : rec.size();
    switch(size) {
    case 80: liveid_cid = convert<const std::string&, std::string>(rec[79]);
        liveid_cid.setModified(false);
    case 79: sent_authrequest_extrasbitmask = convert<const std::string&, int>(rec[78]);
        sent_authrequest_extrasbitmask.setModified(false);
    case 78: authreq_initmethod = convert<const std::string&, int>(rec[77]);
        authreq_initmethod.setModified(false);
    case 77: sent_authrequest_initmethod = convert<const std::string&, int>(rec[76]);
        sent_authrequest_initmethod.setModified(false);
    case 76: phone_mobile_normalized = convert<const std::string&, std::string>(rec[75]);
        phone_mobile_normalized.setModified(false);
    case 75: phone_office_normalized = convert<const std::string&, std::string>(rec[74]);
        phone_office_normalized.setModified(false);
    case 74: phone_home_normalized = convert<const std::string&, std::string>(rec[73]);
        phone_home_normalized.setModified(false);
    case 73: unified_servants = convert<const std::string&, std::string>(rec[72]);
        unified_servants.setModified(false);
    case 72: main_phone = convert<const std::string&, std::string>(rec[71]);
        main_phone.setModified(false);
    case 71: pop_score = convert<const std::string&, int>(rec[70]);
        pop_score.setModified(false);
    case 70: authreq_src = convert<const std::string&, int>(rec[69]);
        authreq_src.setModified(false);
    case 69: authreq_crc = convert<const std::string&, int>(rec[68]);
        authreq_crc.setModified(false);
    case 68: node_capabilities_and = convert<const std::string&, int>(rec[67]);
        node_capabilities_and.setModified(false);
    case 67: offline_authreq_id = convert<const std::string&, int>(rec[66]);
        offline_authreq_id.setModified(false);
    case 66: stack_version = convert<const std::string&, int>(rec[65]);
        stack_version.setModified(false);
    case 65: in_shared_group = convert<const std::string&, int>(rec[64]);
        in_shared_group.setModified(false);
    case 64: added_in_shared_group = convert<const std::string&, int>(rec[63]);
        added_in_shared_group.setModified(false);
    case 63: revoked_auth = convert<const std::string&, int>(rec[62]);
        revoked_auth.setModified(false);
    case 62: node_capabilities = convert<const std::string&, int>(rec[61]);
        node_capabilities.setModified(false);
    case 61: sent_authrequest_serial = convert<const std::string&, int>(rec[60]);
        sent_authrequest_serial.setModified(false);
    case 60: sent_authrequest_time = convert<const std::string&, int>(rec[59]);
        sent_authrequest_time.setModified(false);
    case 59: sent_authrequest = convert<const std::string&, std::string>(rec[58]);
        sent_authrequest.setModified(false);
    case 58: authorized_time = convert<const std::string&, int>(rec[57]);
        authorized_time.setModified(false);
    case 57: last_used_networktime = convert<const std::string&, int>(rec[56]);
        last_used_networktime.setModified(false);
    case 56: contactlist_track = convert<const std::string&, int>(rec[55]);
        contactlist_track.setModified(false);
    case 55: server_synced = convert<const std::string&, int>(rec[54]);
        server_synced.setModified(false);
    case 54: nr_of_buddies = convert<const std::string&, int>(rec[53]);
        nr_of_buddies.setModified(false);
    case 53: account_modification_serial_nr = convert<const std::string&, int>(rec[52]);
        account_modification_serial_nr.setModified(false);
    case 52: certificate_send_count = convert<const std::string&, int>(rec[51]);
        certificate_send_count.setModified(false);
    case 51: isblocked = convert<const std::string&, int>(rec[50]);
        isblocked.setModified(false);
    case 50: external_system_id = convert<const std::string&, std::string>(rec[49]);
        external_system_id.setModified(false);
    case 49: external_id = convert<const std::string&, std::string>(rec[48]);
